        ...
        <div className="container mx-auto">
          <div className="flex flex-col xl:flex-row gap-24">
            ...
            <div className="flex flex-col items-center text-center lg-items-start lg:text-left">
                ...
                <button  style={{background:'var(--red'}} className='btn btn-md bg-accent hover:bg-accent-hover transition-all w-full rounded-lg text-xl mt-10' data-aos="zoom-in-up" data-aos-duration="2600" >Contact me</button>
